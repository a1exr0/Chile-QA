...
Created for: Rojabet Chile (https://rojabet.com/)
Based on: Coolbet Chile test scenarios document structure

**Version 1.0 Release Notes:**
- Complete test scenario documentation for Rojabet Chile
- Covers full user journey: Registration → Login → KYC → Deposit → Betting → Withdrawal
- Focused on success scenarios (positive testing only)
- Includes comprehensive screenshot requirements
- Adapted for Chilean market specifics
